package com.redeSocial.projeto.program;
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 1:
			    ...
			    System.out.println();
			    User newUser = new User(username, password, name, birthdate, relationship, null, null, null, null, null, null, null, username, null, username);
			    break;
			case 2:
			    sc.nextLine();
			    do {
